...
// I was wrong, the value of y is already set to four. When we try to find the value of z, we need to use the mystery function
// in which that function mulitplies y times two.
